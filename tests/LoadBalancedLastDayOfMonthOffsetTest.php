...
class LoadBalancedLastDayOfMonthOffsetTest extends TestSetup
{
    ...
    public function local_task_last_day_of_month_offset()
    {
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-12-29 15:30:02')
            ->loadBalanced()
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-04-30 11:00:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-05-21 11:00:39')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-02-26 15:30:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
            ->lastDayOfMonthOffset(2, '15:30')
            ->run();
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2024-02-27 15:30:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
            ->lastDayOfMonthOffset(2, '15:30')
            ->run();
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-12-31 00:00:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
    ...
    public function local_task_last_day_of_month_offset_not_in_time()
    {
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-12-30 00:00:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
            ->lastDayOfMonthOffset()
            ->run();
