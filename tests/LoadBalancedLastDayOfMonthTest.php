...
class LoadBalancedLastDayOfMonthTest extends TestSetup
{
    ...
    public function local_task_last_day_of_month()
    {
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-12-31 15:30:02')
            ->loadBalanced()
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-02-28 15:30:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
            ->lastDayOfMonth('15:30')
            ->run();
        ...
        // leap year
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2020-02-29 15:30:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
            ->lastDayOfMonth('15:30')
            ->run();
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-04-30 00:00:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
            ->lastDayOfMonth()
            ->run();
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-08-31 23:59:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-09-30 23:59:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
            ->lastDayOfMonth('23:59')
            ->run();
    ...
    {
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-09-29 23:59:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
            ->lastDayOfMonth('23:59')
            ->run();
        ...
        $response = (new LoadBalancedCronTask())
            ->mockTestEnvironment($this->sqlitedb, '2022-08-01 23:59:02')
            ->loadBalanced()
            ->task((new DefaultCronTask()))
